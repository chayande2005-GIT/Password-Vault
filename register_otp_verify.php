...
<body>
    ...
    <section class="login-container">
        <div class="login-box">
            ...
            <form action="register_otp_check.php" method="POST">
            ...
            <?php if (isset($_SESSION['register_otp_error'])): ?>
            <div style="color: red; margin-bottom: 1em;">
                Invalid OTPs.
                <form action="register_otp_verify.php" method="get" style="display:inline;">
            ...
            <?php unset($_SESSION['register_otp_error']); ?>
        <?php endif; ?>
        </div>
    </section>
